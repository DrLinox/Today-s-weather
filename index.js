...
function getTemp(infos) {
    ...
    forecastdays[0].textContent = forecastday1.toLocaleString('en-us', {  weekday: 'short' })
    const forecastday2 = new Date(infos.forecast.forecastday[2].date)
    forecastdays[1].textContent = forecastday2.toLocaleString('en-us', {  weekday: 'short' })
    const forecastday3 = new Date(infos.forecast.forecastday[3].date)
    forecastdays[2].textContent = forecastday3.toLocaleString('en-us', {  weekday: 'short' })
